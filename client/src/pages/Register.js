            ...
            <Grid container>
                ...
                <Grid item md={4} sx={{ p: 5 }} >
                    <form onSubmit={handleSubmit(onSubmit)} className="login-form" style={{ padding: '70px', marginTop: "100px" }} >
                        ...
                        <TextField sx={{ mt: 4, backgroundColor: '#333333', borderRadius: '5px' }} fullWidth id="outlined-basic" label="Confirm Password" type="password" variant="outlined" {...register("password", { required: true })} />
                        <Stack sx={{ mt: 1 }}>
